...
public class AgentConstant {
     ...
     */
    public static final String AGENT_METRIC_PANEL_NAME_INPUT_BYTES_PER_MIN = "Agent数据流入口采集流量bytes/分钟";
    /**
     * Agent指标名 - Agent入口采集流量bytes/分钟
     */
    public static final String AGENT_METRIC_NAME_INPUT_BYTES_PER_MIN = "Agent数据流入口采集流量bytes/分钟";
    /**
     * Agent指标名 - Agent出口发送流量bytes/分钟
     */
    public static final String AGENT_METRIC_NAME_OUTPUT_BYTES_PER_MIN = "Agent数据流出口发送流量bytes/分钟";
    /**
     * Agent指标面板名 - Agent出口发送流量bytes/分钟
     */
    public static final String AGENT_METRIC_PANEL_NAME_OUTPUT_BYTES_PER_MIN = "Agent数据流出口发送流量bytes/分钟";
    /**
     ...
     */
    public static final String AGENT_METRIC_PANEL_NAME_INPUT_BYTES_PER_LOG_COLLECT_TASK_PER_MIN = "Agent各日志采集任务对应数据流入口采集流量bytes/分钟";
    /**
     ...
     */
    public static final String AGENT_METRIC_PANEL_NAME_OUTPUT_BYTES_PER_LOG_COLLECT_TASK_PER_MIN = "Agent各日志采集任务对应数据流出口采集流量bytes/分钟";
    /**
