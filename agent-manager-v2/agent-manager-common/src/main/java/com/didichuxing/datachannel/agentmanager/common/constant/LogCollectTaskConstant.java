...
public class LogCollectTaskConstant {
    ...
    public static final String LOG_COLLECT_TASK_METRIC_NAME_LOGS_BYTES_PER_MIN = "日志采集任务对应日志采集流量 MB/30s";
    public static final String LOG_COLLECT_TASK_METRIC_PANEL_NAME_LOGS_BYTES_PER_MIN = "日志采集任务对应日志采集流量 MB/30s";
    ...
    public static final String LOG_COLLECT_TASK_METRIC_PANEL_NAME_LOGS_COUNT_PER_MIN = "日志采集任务对应日志采集条数/30s";
    public static final String LOG_COLLECT_TASK_METRIC_NAME_LOGS_COUNT_PER_MIN = "日志采集任务对应日志采集条数/30s";

    public static final String LOG_PATH_METRIC_PANEL_GROUP_NAME_RUNTIME = "LogCollectTask 各 logpath 运行时相关指标";

    public static final String LOG_COLLECT_TASK_METRIC_PANEL_NAME_CURRENT_COLLECT_TIME_PER_LOG_PATH_PER_MIN = "各logPath对应日志采集时间/30s";

    public static final String LOG_COLLECT_TASK_METRIC_PANEL_NAME_CURRENT_COLLECT_TIME_PER_LOG_PATH_PER_HOST_PER_MIN = "各logPath对应在各host上对应当前日志采集时间/30s";
    ...
    public static final String LOG_COLLECT_TASK_METRIC_PANEL_NAME_FILELOGPATH_LIMIT_TIME_PER_MIN = "日志采集路径限流时长 ms/30s";
