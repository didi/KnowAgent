...
public class AgentStatistics extends AbstractStatistics {
    ...
    public AgentStatistics(String name, LimitService limiter, Long startTime, Integer runningCollectTaskNum, Integer runningCollectPathNum) throws MetricsException {
        super(name);
    ...
    public void getMetrics(MetricsBuilder builder, boolean all) {
         ...
         * 将agent相关指标存入待发送缓存队列
         */
        metricsRegistry.tag(MetricsFieldConstant.AGENT_METRICS, null, JSON.toJSONString(agentMetrics), true);
     ...
     */
    private AgentBusinessMetrics buildAgentBusinessMetrics(String hostName, Long heartbeatTime, Long heartbeatTimeMinute, Long heartbeatTimeHour, Long heartbeatTimeDay) {
    ...
    private List<NetCardMetrics> buildNetCardMetricsList() {
     ...
     */
    private ProcessMetrics buildProcessMetrics(String hostName, Long heartbeatTime, Long heartbeatTimeMinute, Long heartbeatTimeHour, Long heartbeatTimeDay) {
        ...
        processMetrics.setProccpuutil55quantile(processMetricsService.getProcCpuUtil().getQuantile55());
        processMetrics.setProccpuutil75quantile(processMetricsService.getProcCpuUtil().getQuantile75());
        processMetrics.setProccpuutil95quantile(processMetricsService.getProcCpuUtil().getQuantile95());
        processMetrics.setProccpuutil99quantile(processMetricsService.getProcCpuUtil().getQuantile99());
        processMetrics.setProcmemused(processMetricsService.getProcMemUsed());
        processMetrics.setProcnetworksendbytesps(processMetricsService.getProcNetworkSendBytesPs().getLast().longValue());
        processMetrics.setProcnetworksendbytespsmin(processMetricsService.getProcNetworkSendBytesPs().getMin().longValue());
        processMetrics.setProcnetworksendbytespsmax(processMetricsService.getProcNetworkSendBytesPs().getMax().longValue());
        processMetrics.setProcnetworksendbytespsmean(processMetricsService.getProcNetworkSendBytesPs().getAvg().longValue());
        processMetrics.setProcnetworksendbytespsstd(processMetricsService.getProcNetworkSendBytesPs().getStdDev().longValue());
        processMetrics.setProcnetworksendbytesps55quantile(processMetricsService.getProcNetworkSendBytesPs().getQuantile55().longValue());
        processMetrics.setProcnetworksendbytesps75quantile(processMetricsService.getProcNetworkSendBytesPs().getQuantile75().longValue());
        processMetrics.setProcnetworksendbytesps95quantile(processMetricsService.getProcNetworkSendBytesPs().getQuantile95().longValue());
        processMetrics.setProcnetworksendbytesps99quantile(processMetricsService.getProcNetworkSendBytesPs().getQuantile99().longValue());
        processMetrics.setProcnetworkreceivebytesps(processMetricsService.getProcNetworkReceiveBytesPs().getLast().longValue());
        processMetrics.setProcnetworkreceivebytespsmin(processMetricsService.getProcNetworkReceiveBytesPs().getMin().longValue());
        processMetrics.setProcnetworkreceivebytespsmax(processMetricsService.getProcNetworkReceiveBytesPs().getMax().longValue());
        processMetrics.setProcnetworkreceivebytespsmean(processMetricsService.getProcNetworkReceiveBytesPs().getAvg().longValue());
        processMetrics.setProcnetworkreceivebytespsstd(processMetricsService.getProcNetworkReceiveBytesPs().getStdDev().longValue());
        processMetrics.setProcnetworkreceivebytesps55quantile(processMetricsService.getProcNetworkReceiveBytesPs().getQuantile55().longValue());
        processMetrics.setProcnetworkreceivebytesps75quantile(processMetricsService.getProcNetworkReceiveBytesPs().getQuantile75().longValue());
        processMetrics.setProcnetworkreceivebytesps95quantile(processMetricsService.getProcNetworkReceiveBytesPs().getQuantile95().longValue());
        processMetrics.setProcnetworkreceivebytesps99quantile(processMetricsService.getProcNetworkReceiveBytesPs().getQuantile99().longValue());
     ...
     * @return 返回构建完成的SystemMetrics对象
     */
    private SystemMetrics buildSystemMetrics(String hostName, Long heartbeatTime, Long heartbeatTimeMinute, Long heartbeatTimeHour, Long heartbeatTimeDay) {
        ...
        systemMetrics.setSystemcpuutil55quantile(systemMetricsService.getSystemCpuUtil().getQuantile55());
        systemMetrics.setSystemcpuutil75quantile(systemMetricsService.getSystemCpuUtil().getQuantile75());
        systemMetrics.setSystemcpuutil95quantile(systemMetricsService.getSystemCpuUtil().getQuantile95());
        systemMetrics.setSystemcpuutilmax(systemMetricsService.getSystemCpuUtil().getMax());
        systemMetrics.setSystemcpuutil99quantile(systemMetricsService.getSystemCpuUtil().getQuantile99());
        ...
        systemMetrics.setSystemNetworkSendAndReceiveBytesPs(systemMetricsService.getSystemNetworkSendAndReceiveBytesPs().getLast());
        systemMetrics.setSystemNetworkSendAndReceiveBytesPsMin(systemMetricsService.getSystemNetworkSendAndReceiveBytesPs().getMin());
        systemMetrics.setSystemNetworkSendAndReceiveBytesPsMax(systemMetricsService.getSystemNetworkSendAndReceiveBytesPs().getMax());
        systemMetrics.setSystemNetworkSendAndReceiveBytesPsMean(systemMetricsService.getSystemNetworkSendAndReceiveBytesPs().getAvg());
        systemMetrics.setSystemNetworkSendAndReceiveBytesPsStd(systemMetricsService.getSystemNetworkSendAndReceiveBytesPs().getStdDev());
        systemMetrics.setSystemNetworkSendAndReceiveBytesPs55Quantile(systemMetricsService.getSystemNetworkSendAndReceiveBytesPs().getQuantile55());
        systemMetrics.setSystemNetworkSendAndReceiveBytesPs75Quantile(systemMetricsService.getSystemNetworkSendAndReceiveBytesPs().getQuantile75());
        systemMetrics.setSystemNetworkSendAndReceiveBytesPs95Quantile(systemMetricsService.getSystemNetworkSendAndReceiveBytesPs().getQuantile95());
        systemMetrics.setSystemNetworkSendAndReceiveBytesPs99Quantile(systemMetricsService.getSystemNetworkSendAndReceiveBytesPs().getQuantile99());
        systemMetrics.setSystemNetWorkBandWidthUsedPercent(systemMetricsService.getSystemNetWorkBandWidthUsedPercent().getLast());
        systemMetrics.setSystemNetWorkBandWidthUsedPercentMin(systemMetricsService.getSystemNetWorkBandWidthUsedPercent().getMin());
        systemMetrics.setSystemNetWorkBandWidthUsedPercentMax(systemMetricsService.getSystemNetWorkBandWidthUsedPercent().getMax());
        systemMetrics.setSystemNetWorkBandWidthUsedPercentMean(systemMetricsService.getSystemNetWorkBandWidthUsedPercent().getAvg());
        systemMetrics.setSystemNetWorkBandWidthUsedPercentStd(systemMetricsService.getSystemNetWorkBandWidthUsedPercent().getStdDev());
        systemMetrics.setSystemNetWorkBandWidthUsedPercent55Quantile(systemMetricsService.getSystemNetWorkBandWidthUsedPercent().getQuantile55());
        systemMetrics.setSystemNetWorkBandWidthUsedPercent75Quantile(systemMetricsService.getSystemNetWorkBandWidthUsedPercent().getQuantile75());
        systemMetrics.setSystemNetWorkBandWidthUsedPercent95Quantile(systemMetricsService.getSystemNetWorkBandWidthUsedPercent().getQuantile95());
        systemMetrics.setSystemNetWorkBandWidthUsedPercent99Quantile(systemMetricsService.getSystemNetWorkBandWidthUsedPercent().getQuantile99());
    ...
    private AgentMetrics buildAgentMetrics() {
        ...
        SystemMetrics systemMetrics = buildSystemMetrics(hostName, heartbeatTime, heartbeatTimeMinute, heartbeatTimeHour, heartbeatTimeDay);
        ProcessMetrics processMetrics = buildProcessMetrics(hostName, heartbeatTime, heartbeatTimeMinute, heartbeatTimeHour, heartbeatTimeDay);
        List<DiskIOMetrics> diskIOMetricsList = buildDiskIOMetricsList(hostName, heartbeatTime, heartbeatTimeMinute, heartbeatTimeHour, heartbeatTimeDay);
        List<NetCardMetrics> netCardMetricsList = buildNetCardMetricsList();
        AgentBusinessMetrics agentBusinessMetrics = buildAgentBusinessMetrics(hostName, heartbeatTime, heartbeatTimeMinute, heartbeatTimeHour, heartbeatTimeDay);
        AgentMetrics agentMetrics = new AgentMetrics(systemMetrics, processMetrics, diskIOMetricsList, netCardMetricsList, agentBusinessMetrics);
        return agentMetrics;
    }
