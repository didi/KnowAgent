...
public class LogCollectTaskConstant {
    ...
    public static final String LOG_COLLECT_TASK_METRIC_NAME_LOGS_BYTES_PER_MIN = "日志采集任务对应日志采集流量 MB/分钟";
    public static final String LOG_COLLECT_TASK_METRIC_PANEL_NAME_LOGS_BYTES_PER_MIN = "日志采集任务对应日志采集流量 MB/分钟";
