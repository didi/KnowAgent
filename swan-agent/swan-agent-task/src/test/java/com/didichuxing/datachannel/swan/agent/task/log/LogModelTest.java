...
public class LogModelTest extends LogFileUtils {
    ...
    public void replaceHostName() {
        String path0 = "/tmp/new-swan-agent/logSourceTest/didi.log";
        String path1 = "/tmp/new-swan-agent/logSourceTest/didi_${hostname}.log";
        String path11 = "/tmp/new-swan-agent/logSourceTest/didi_" + CommonUtils.getHOSTNAME() + ".log";
        String path2 = "/tmp/new-swan-agent/logSourceTest_${hostname}/didi.log";
        String path21 = "/tmp/new-swan-agent/logSourceTest_" + CommonUtils.getHOSTNAME() + "/didi.log";
