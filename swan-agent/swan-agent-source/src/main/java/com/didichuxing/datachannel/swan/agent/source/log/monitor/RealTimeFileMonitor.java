...
public enum RealTimeFileMonitor implements Monitor {
    ...
    public boolean unregister(LogSource logSource) {
        ...
        if (!dirMap.containsKey(dir)) {
            LOGGER.warn("dir is not in com.didichuxing.datachannel.swan.agent.source.log.monitor!ignore");
            return true;
        }
    ...
    public void start() {
        ...
        LOGGER.info("begin to init inotify watchThread to com.didichuxing.datachannel.swan.agent.source.log.monitor file change.");
