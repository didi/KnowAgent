package com.didichuxing.datachannel.swan.agent.source.log.offset;
...
private static final Logger LOGGER = LoggerFactory.getLogger(OffsetManager.class.getName());private static final String                                       OLD_AGENT_PATH                 = System.getProperty("user.home")
    ...
    public static final String                                        TMP_SUFFIX                     = ".swanagent.tmp";
    public static final String                                        DEL_SUFFIX                     = ".swanagent.del";
