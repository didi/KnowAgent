...
import com.didichuxing.datachannel.swan.agent.common.api.FileReadType;
...
public class FileReaderTest {
    ...
    private static final String filePath1      = "/tmp/new-swan-agent/file1";
    private static final String filePath2      = "/tmp/new-swan-agent/file2";
    private static final String filePath3      = "/tmp/new-swan-agent/file3";
    private static final String filePath3_1    = "/tmp/new-swan-agent/file3_1";
    private static final String filePath4      = "/tmp/new-swan-agent/file4";
    private static final String filePath5      = "/tmp/new-swan-agent/file5";
    private static final String filePath5_back = "/tmp/new-swan-agent/file5_back";
    private static final String filePath6_1    = "/tmp/new-swan-agent/file6_1";
    private static final String filePath6_2    = "/tmp/new-swan-agent/file6_2";
    private static final String filePath7      = "/tmp/new-swan-agent/file7";
