...
public class HttpServiceTest {
    ...
    public void version() throws Exception {
        String response = HttpUtils.get("http://127.0.0.1:2023/swan-agent/version", null);
    ...
    public void pid() throws Exception {
        String response = HttpUtils.get("http://127.0.0.1:2023/swan-agent/pid", null);
    ...
    public void command() throws Exception {
        ...
        String response = HttpUtils.post("http://127.0.0.1:2023/swan-agent/command", map);
        System.out.println(response);
