...
public class AgentOperationTaskDetailVO {
    ...
    @ApiModelProperty(value = "Agent版本号 注：卸载时值不存在", notes="")
    private String agentVersion;

    @ApiModelProperty(value = "Agent操作任务执行明细列表", notes="")
    private AgentOperationTaskExecuteDetailListVO agentOperationTaskExecuteDetailListVO;
    ...
    public AgentOperationTaskExecuteDetailListVO getAgentOperationTaskExecuteDetailListVO() {
        return agentOperationTaskExecuteDetailListVO;
    }

    public void setAgentOperationTaskExecuteDetailListVO(AgentOperationTaskExecuteDetailListVO agentOperationTaskExecuteDetailListVO) {
        this.agentOperationTaskExecuteDetailListVO = agentOperationTaskExecuteDetailListVO;
    }
