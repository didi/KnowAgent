...
//import com.didichuxing.datachannel.agentmanager.common.bean.dto.metrics.SystemMetricsQueryDTO;
...
//    @ResponseBody
//    public Result<List<MetricAggregate>> getHeartbeatCountMetric(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
...
//    @ResponseBody
//    public Result<MetricList> maxDelay(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
...
//    @ResponseBody
//    public Result<MetricList> minLogTime(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> limitTime(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> abnormalTruncation(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> collectPathExists(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> fileOrder(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> sliceError(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> readByte(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> readCount(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> readTimeConsuming(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> readTimeMin(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> readTimeMax(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> readTimeMean(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> sendBytes(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> sendCount(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> sendTimeConsuming(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> sendTimeMax(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> sendTimeMean(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> sendTimeMin(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> flushCount(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> flushTimeMax(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> flushTimeMean(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> flushTimeMin(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> flushFailedCount(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    @ResponseBody
//    public Result<MetricList> filterTimes(@RequestBody SystemMetricsQueryDTO metricQueryDTO) {
//        Result result = checkMetricQueryParam(metricQueryDTO);
//        if (result.failed()) {
//            return result;
//        }
...
//    }
//
//    private Result checkMetricQueryParam(SystemMetricsQueryDTO metricQueryDTO) {
