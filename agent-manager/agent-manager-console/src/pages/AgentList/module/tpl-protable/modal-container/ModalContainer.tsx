    ...
    <>
      {containerType && containerType === 'modal' && (
        <Modal
          ...
          width={containerConfig.width ? containerConfig.width : '500px'}
          footer={
            containerConfig.footer || containerConfig.footer === null || containerConfig.footer === false
      ...
      {containerType && containerType === 'drawer' && (
        <Drawer
          ...
          width={containerConfig.width ? containerConfig.width : '1080px'}
          bodyStyle={{ padding: 0 }}
        >
