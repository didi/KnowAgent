...
const regName = /^([-_.a-zA-Z0-9\u4e00-\u9fa5]{1,128})$/; // 支持中英文字母、大小写、数字、下划线、点、短横线。32位限制
...
const regClusterAdress = /^([-_.:,a-zA-Z0-9\u4e00-\u9fa5]{1,1024})$/; // 支持中英文字母、大小写、数字、下划线、点、短横线。32位限制
        ...
        <Form form={props.form} name="actionApp" layout="vertical">
          <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: '请输入集群名，支持大小写中英文字母、数字、下划线、短横线，128位限制',
                  ...
                  validator: (_, v, c) => {
                    ...
                    c('请输入集群名，支持大小写中英文字母、数字、下划线、短横线，128位限制');
                  },
                  // initialValue: cluster && cluster.kafkaClusterName,
                },
              ]}
          ...
          <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: '请输入集群地址，支持限制中英文字母、大小写、数字、下划线、短横线、点、冒号、逗号，1024位限制',
                  // validator: (rule: any, value: string) => {
                  //   return !!value && new RegExp(regAdress).test(value);
                  // },
                  validator: (_, v, c) => {
                    if (!!v && new RegExp(regClusterAdress).test(v)) {
                      c();
                      return;
                    }
                    c('请输入集群地址，支持限制中英文字母、大小写、数字、下划线、短横线、点、冒号、逗号，1024位限制');
                  },
                  // initialValue: cluster && cluster.kafkaClusterBrokerConfiguration,
                },
              ]}
