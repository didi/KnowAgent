...
export const formatMap = {
  ...
  logCollectTaskCreateTime: (t: number, record) => {
    return getTimeType(record.logCollectTaskCreateTime);
  },
  logCollectTaskType: (t: number, record) => {
    const collectModeMap = {
      0: '流式采集',
      1: '时间段补采',
    };
    return collectModeMap[t];
  },
};
